...
function Get-RaymanWorkspacePlatformTargetFrameworksFromText {
    ...
    if (Get-Command Get-RaymanDotNetTargetFrameworksFromText -ErrorAction SilentlyContinue) {
        return @(Get-RaymanDotNetTargetFrameworksFromText -ProjectText $ProjectText)
    }
