...
try {
  ...
  $mirrorRel = @(
    ...
    'scripts/skills/manage_skills.ps1'
    ...
    'scripts/agents/validate_manual_command_contracts.ps1'
    'scripts/agents/ensure_agent_capabilities.ps1'
    'scripts/agents/agentic_pipeline.ps1'
    'scripts/agents/context_audit.ps1'
    ...
    'scripts/workspace/install_workspace.ps1'
    'scripts/workspace/register_workspace.ps1'
    'scripts/workspace/registered_workspace_bootstrap.ps1'
    'scripts/codex/codex_common.ps1'
    'scripts/codex/manage_accounts.ps1'
    'scripts/codex/codex_notify.ps1'
    ...
    'scripts/utils/event_hooks.ps1'
    'scripts/utils/request_attention.ps1'
    'scripts/utils/post_command_hygiene.ps1'
    'scripts/utils/sound_check.ps1'
    'scripts/utils/runtime_cleanup.ps1'
    ...
    'config/event_hooks.json'
    'config/skills_registry.json'
    'config/prompt_eval_suites.json'
    ...
    'scripts/state/check_pending_task.ps1'
    'scripts/state/list_state.ps1'
    'scripts/state/rollback_state.ps1'
    'scripts/state/resume_state.ps1'
    'scripts/state/save_state.ps1'
    'scripts/state/session_common.ps1'
    'scripts/state/worktree_create.ps1'
    ...
    'scripts/testing/verify_cli_parity.ps1'
    ...
    'scripts/testing/pester/manual_command_contracts.Tests.ps1'
    'scripts/testing/pester/manage_workers.Tests.ps1'
    'scripts/testing/pester/worker_auto_sync.Tests.ps1'
    'scripts/testing/pester/worker_common.Tests.ps1'
    'scripts/testing/pester/worker_host.Tests.ps1'
    'scripts/testing/pester/worker_sync.Tests.ps1'
    'scripts/testing/pester/workspace_install.Tests.ps1'
    'scripts/testing/pester/workspace_register.Tests.ps1'
    'scripts/testing/pester/ensure_playwright_ready.Tests.ps1'
    'scripts/testing/pester/release_gate.Tests.ps1'
    'scripts/testing/pester/network_resume_watch.Tests.ps1'
    ...
    'scripts/testing/pester/post_command_hygiene.Tests.ps1'
    'scripts/testing/pester/rayman_cli_hygiene.Tests.ps1'
    'scripts/testing/pester/release_gate.lib.Tests.ps1'
    'scripts/testing/pester/runtime_cleanup.Tests.ps1'
    ...
    'scripts/testing/pester/command_catalog.Tests.ps1'
    'scripts/testing/pester/context_audit.Tests.ps1'
    'scripts/testing/pester/prompt_eval.Tests.ps1'
    'scripts/testing/pester/skills_registry.Tests.ps1'
    'scripts/testing/pester/state_sessions.Tests.ps1'
  ...
  if ($enforceTrackedness -and $trackedPending.Count -gt 0) {
    Fail ("git index pending mirrored assets: {0}（请先 git add 对应 source/dist 资产）" -f ($trackedPending -join ' '))
  }
